...
<form  class="navbar-form" action="/search-cmc" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
                      ...
                      <input onkeyup="showcm('All')" id="nameinputid" type="text" class="form-control navbar-left" name="people" data-toggle="modal" data-target="#myModal1" placeholder="Search Hotel" style="display: inline; width: 700px; height: 30px; border-radius: 2px black;">
